...
const Navbar: React.FC = () => {
  ...
  <a
    ...
    target="_blank"
    rel="noopener noreferrer"
    className="bg-amber-400 text-black px-3 py-2 rounded font-bold text-sm flex items-center gap-2"
  >
    {/* WhatsApp Icon SVG (optional) */}
    <svg
      className="w-4 h-4"
    ...
    Join WhatsApp
            ...
            <button
              onClick={() => (window.location.href = "https://sklassics-ai.com/login")}
              className="border border-neutral-500 text-yellow-500   px-3 py-2 rounded hover:bg-yellow-800 text-sm"
            >
              Login
            </button>
          </div>
